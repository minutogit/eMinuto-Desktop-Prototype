...
class TestPerson(unittest.TestCase):
    def setUp(self):
        ...
        self.test_person[1].read_voucher_and_save_voucher(self.voucher_path)
        ...
        self.test_person[2].read_voucher_and_save_voucher(self.male_signed_voucher_path)
    ...
    def test_voucher_creation_and_persistence(self):
        ...
        self.test_person[0].read_voucher_and_save_voucher(self.voucher_path)
    ...
    def test_male_guarantor_signature(self):
        ...
        self.test_person[1].read_voucher_and_save_voucher(self.male_signed_voucher_path)
    ...
    def test_female_guarantor_signature(self):
        ...
        self.test_person[2].read_voucher_and_save_voucher(self.male_female_signed_voucher_path)
    ...
    def test_creator_signature_verification(self):
        ...
        self.test_person[0].read_voucher_and_save_voucher(self.male_female_signed_voucher_path)
        ...
        self.test_person[3].read_voucher_and_save_voucher(complete_voucher_path)
