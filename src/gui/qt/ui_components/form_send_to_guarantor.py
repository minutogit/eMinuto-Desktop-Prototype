...
class Ui_FormSendToGuarantor(object):
    ...
    def retranslateUi(self, FormSendToGuarantor):
        FormSendToGuarantor.setWindowTitle(QCoreApplication.translate("FormSendToGuarantor", u"Have Others Sign as Guarantors", None))
        self.label_user_id.setText(QCoreApplication.translate("FormSendToGuarantor", u"Your User ID (Address to Receive)", None))
        self.lineEdit_user_ID.setPlaceholderText("")
#if QT_CONFIG(tooltip)
        self.pushButton_copy_user_ID.setToolTip(QCoreApplication.translate("FormSendToGuarantor", u"Copy", None))
#endif // QT_CONFIG(tooltip)
        self.pushButton_copy_user_ID.setText("")
        self.label_guarantor_ID.setText(QCoreApplication.translate("FormSendToGuarantor", u"Guarantor ID (Address of Guarantor to Sign)", None))
#if QT_CONFIG(tooltip)
        ...
        self.label.setText(QCoreApplication.translate("FormSendToGuarantor", u"Guarantor's Email Address:", None))
#if QT_CONFIG(tooltip)
        self.lineEdit_guarantor_email_address.setToolTip("")
#endif // QT_CONFIG(tooltip)
        self.lineEdit_guarantor_email_address.setPlaceholderText(QCoreApplication.translate("FormSendToGuarantor", u"Email sending not available yet", None))
        self.label_guarantor_id_check_2.setText("")
        self.checkBox_encrypt_voucher.setText(QCoreApplication.translate("FormSendToGuarantor", u"Encrypt data", None))
#if QT_CONFIG(tooltip)
        self.pushButton_save_as_file.setToolTip("")
#endif // QT_CONFIG(tooltip)
        self.pushButton_save_as_file.setText(QCoreApplication.translate("FormSendToGuarantor", u"Save as file", None))
#if QT_CONFIG(tooltip)
        self.pushButton_send_as_email.setToolTip("")
#endif // QT_CONFIG(tooltip)
        self.pushButton_send_as_email.setText(QCoreApplication.translate("FormSendToGuarantor", u"Send as email", None))
        self.label_.setText("")
    # retranslateUi
