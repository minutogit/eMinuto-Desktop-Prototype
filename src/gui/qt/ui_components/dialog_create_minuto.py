...
class Ui_DialogCreateMinuto(object):
    def setupUi(self, DialogCreateMinuto):
        ...
        self.label_footnote = QLabel(DialogCreateMinuto)
        self.label_footnote.setObjectName(u"label_footnote")
        self.label_footnote.setGeometry(QRect(20, 630, 461, 20))
        self.label_footnote.setFont(font)
        self.label_footnote.setAlignment(Qt.AlignCenter)
    ...
    def retranslateUi(self, DialogCreateMinuto):
        DialogCreateMinuto.setWindowTitle(QCoreApplication.translate("DialogCreateMinuto", u"Mint Minuto", None))
        self.label_creator_first_name.setText(QCoreApplication.translate("DialogCreateMinuto", u"First Name", None))
        self.label_creator_last_name.setText(QCoreApplication.translate("DialogCreateMinuto", u"Last Name", None))
        self.label_creator_organization.setText(QCoreApplication.translate("DialogCreateMinuto", u"Organization / Company", None))
        self.label_creator_address.setText(QCoreApplication.translate("DialogCreateMinuto", u"Address", None))
        self.label_creator_gender.setText(QCoreApplication.translate("DialogCreateMinuto", u"Gender", None))
        self.comboBox_creator_gender.setItemText(0, QCoreApplication.translate("DialogCreateMinuto", u"unknown", None))
        self.comboBox_creator_gender.setItemText(1, QCoreApplication.translate("DialogCreateMinuto", u"male", None))
        self.comboBox_creator_gender.setItemText(2, QCoreApplication.translate("DialogCreateMinuto", u"female", None))

        self.label_amount.setText(QCoreApplication.translate("DialogCreateMinuto", u"How many Minuto should be minted?", None))
        ...
        self.checkBox_is_test_voucher.setText(QCoreApplication.translate("DialogCreateMinuto", u"Use as test voucher (without value)", None))
        self.label_phone.setText(QCoreApplication.translate("DialogCreateMinuto", u"Phone", None))
        self.label_email.setText(QCoreApplication.translate("DialogCreateMinuto", u"Email Address", None))
        self.label_own_data.setText(QCoreApplication.translate("DialogCreateMinuto", u"Personal Data", None))
        self.label_voucher_data.setText(QCoreApplication.translate("DialogCreateMinuto", u"Voucher Data", None))
        self.label_footnote.setText("")
        self.label_voucher_description.setText("")
        self.pushButton_CreateVoucher.setText(QCoreApplication.translate("DialogCreateMinuto", u"Create", None))
        self.label_service_offer.setText(QCoreApplication.translate("DialogCreateMinuto", u"Offers / Skills", None))
        self.label_validit_until.setText(QCoreApplication.translate("DialogCreateMinuto", u"Validity", None))
        self.label_years.setText(QCoreApplication.translate("DialogCreateMinuto", u"Years", None))
        ...
        self.label_coordinates.setText(QCoreApplication.translate("DialogCreateMinuto", u"Coordinates", None))
