...
class Ui_DialogCreateMinuto(object):
    def setupUi(self, DialogCreateMinuto):
        ...
        self.checkBox = QCheckBox(self.widget_creator_organization_3)
        ...
        self.horizontalLayout_test_voucher.addWidget(self.checkBox)
        ...
        self.widget = QWidget(DialogCreateMinuto)
        self.widget.setObjectName(u"widget")
        self.widget.setGeometry(QRect(20, 520, 461, 101))
        ...
        self.widget1 = QWidget(DialogCreateMinuto)
        self.widget1.setObjectName(u"widget1")
        self.widget1.setGeometry(QRect(180, 120, 301, 30))
        self.horizontalLayout = QHBoxLayout(self.widget1)
        self.horizontalLayout.setObjectName(u"horizontalLayout")
        self.horizontalLayout.setContentsMargins(0, 0, 0, 0)
        self.label_validit_until = QLabel(self.widget1)
        ...
        self.spinBox_validit_until = QSpinBox(self.widget1)
        self.spinBox_validit_until.setObjectName(u"spinBox_validit_until")
        self.spinBox_validit_until.setMaximumSize(QSize(49, 16777215))
        self.spinBox_validit_until.setFont(font)
        self.spinBox_validit_until.setAlignment(Qt.AlignRight|Qt.AlignTrailing|Qt.AlignVCenter)
        self.spinBox_validit_until.setMinimum(5)
        self.spinBox_validit_until.setMaximum(10)

        self.horizontalLayout.addWidget(self.spinBox_validit_until)

        self.label_years = QLabel(self.widget1)
        ...
        self.widget2 = QWidget(DialogCreateMinuto)
        self.widget2.setObjectName(u"widget2")
        self.widget2.setGeometry(QRect(180, 60, 301, 51))
        self.horizontalLayout_2 = QHBoxLayout(self.widget2)
        self.horizontalLayout_2.setObjectName(u"horizontalLayout_2")
        self.horizontalLayout_2.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_3 = QVBoxLayout()
        self.verticalLayout_3.setObjectName(u"verticalLayout_3")
        self.label_region = QLabel(self.widget2)
        ...
        self.lineEdit_region = QLineEdit(self.widget2)
        ...
        self.label_coordinates = QLabel(self.widget2)
        ...
        self.lineEdit_coordinates = QLineEdit(self.widget2)
    ...
    def retranslateUi(self, DialogCreateMinuto):
        ...
        self.comboBox_creator_gender.setItemText(0, QCoreApplication.translate("DialogCreateMinuto", u"m\u00e4nnlich", None))
        self.comboBox_creator_gender.setItemText(1, QCoreApplication.translate("DialogCreateMinuto", u"weiblich", None))
        self.comboBox_creator_gender.setItemText(2, QCoreApplication.translate("DialogCreateMinuto", u"unbekannt", None))
        ...
        self.checkBox.setText(QCoreApplication.translate("DialogCreateMinuto", u"Als Testgutschein markieren", None))
